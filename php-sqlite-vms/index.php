...
<head>
    ...
    <title><?= ucwords($title) ?> | VMS IMS</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark bg-gradient fixed-top mb-5 " id="topNavBar">
        <div class="container">
            <a class="navbar-brand" href="./">
                <img src="imgs/IMS_group-1-90x90-1.png" height="32" width="32">
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($page == 'home')? 'active' : '' ?>" aria-current="page" href="./">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($page == 'visitors')? 'active' : '' ?>" aria-current="page" href="./?page=visitors">Manage Visitors</a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?php echo ($page == 'users')? 'active' : '' ?>" aria-current="page" href="./?page=users">Admin</a>
                    </li>
                    <?php endif; ?>
                </ul>
            </div>
    ...
    <footer class="position-fixed bottom-0 w-100 bg-gradient bg-light">
        <div class="lh-1 container py-4">
            <div class="text-center">All rights reserved &copy; <?= date("Y") ?> - VMS(php) Developed by:<a href="nabab.shaikh@imsplgroup.com" class='text-body-tertiary'>IMSPLGROUP</a></div>
