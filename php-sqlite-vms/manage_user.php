            ...
            <div class="container-fluid">
                ...
                <form action="" id="update-user">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" id="fullname" value="<?php if(isset($data['fullname']))
                     { echo $data['fullname']; } ?>" autofocus name="fullname" class="form-control rounded-0" required>
                    </div>
                    <div class="mb-3">
                        <label for="username" class="control-label">Username</label>
                        <input type="text" id="username" name="username" value="<?php if(isset($data['username']))
                     { echo $data['username']; } ?>" class="form-control rounded-0" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="status" class="form-label">Choose Floor</label>
                        <select name="floornumber" id="floornumber" class="form-select rounded-0" requried>
                            <option value="1" <?= isset($data['floornumber']) && $data['floornumber'] == 1 ? "selected" : "" ?>>1</option>
                            <option value="2" <?= isset($data['floornumber']) && $data['floornumber'] == 2 ? "selected" : "" ?>>2</option>
                            
                            <option value="4" <?= isset($data['floornumber']) && $data['floornumber'] == 4 ? "selected" : "" ?>>4</option>
                            <option value="5" <?= isset($data['floornumber']) && $data['floornumber'] == 5 ? "selected" : "" ?>>5</option>
