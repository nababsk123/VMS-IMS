            ...
            <div class="container-fluid">
                ...
                <table id="table" class="table table-sm table-bordered">
                    ...
                    <tbody>
                        <tr>
                            <td><b>Photos</b></td>
                            <td><img  width="64px" height="64px" src="upload/<?=$data['userimgurl']?>"></td>
                        </tr>
                        <tr>
                ...
                <div class="text-center">
                    ...
                    <?php else: ?>
                        <a href="./?page=visitors" class="btn btn-sm btn-secondary rounded-0">Back to List</a>
                    <?php endif; ?>
                    ...
                    <?php if(isset($data['visitor_id']) && $data['user_id'] == $_SESSION['user_id']): ?>
                        ...
                        <button class="btn btn-success btn-sm rounded-0 align-content-center" id="print"><span class="material-symbols-outlined align-content-center">print</span> Print</button>   
                    <?php endif; ?>
                </div>
            </div>
        </div>
