                ...
                <div class="table-responsive">
                    <table class="table table-sm table-bordered table-hover table-striped" id="visitorTBL">
                        ...
                        <tbody>
                            ...
                            $i = 1;
                            if(isset($_COOKIE['floornumberafterlogin'])){
                            $visitors_sql = "SELECT * FROM `visitor_list` where  `floornumber`={$floornumber} AND date(`date_out`) IS NULL AND date(`date_created`) BETWEEN '{$from}' and '{$to}' ORDER BY strftime('%s', `date_created`) desc";
                            }else{
                                 $visitors_sql = "SELECT * FROM `visitor_list` where date(`date_out`) IS NULL AND date(`date_created`) BETWEEN '{$from}' and '{$to}' ORDER BY strftime('%s', `date_created`) desc";  
                            }
